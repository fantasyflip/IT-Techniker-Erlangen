public class Kassenpatient extends Patient {
     ...
     * eine PraxisVollException werfen kann.
     *
     * Da PraxisVollException eine "checked exception" ist (vom Compiler geprüft),
     * muss jede Methode (einschließlich Konstruktoren), die potenziell eine solche
     * Ausnahme werfen kann (sei es direkt oder durch Aufruf einer anderen Methode),
     * diese Ausnahme in ihrer Signatur mit "throws" deklarieren.
     *
