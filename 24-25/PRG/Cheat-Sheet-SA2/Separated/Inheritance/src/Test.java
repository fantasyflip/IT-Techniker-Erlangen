public class Test {
    public static void main(String[] args) {
        ...
        // Elternklasse gespeichert werden. In diesem Beispiel können "Papagei"
        // und "Wellensittich" in einem Array von "Vogel" gespeichert werden,
        // da sie beide von der Klasse "Vogel" abstammen.
        Vogel[] nest = new Vogel[5];

        nest[0] = new Papagei("Peter", 21.4, "gruen");
        nest[1] = new Wellensittich("Ruediger", 25.0, 4.7);

        // Da in der Elternklasse definiert ist, dass es eine Methode "toString"
        // gibt kann diese Methode auch auf den im Array aus "Vogel" gespeicherten
        // Objekten ausgeführt werden. Je nachdem ob das betroffene Objekt dann ein
        // "Papagei" oder ein "Wellensittich" ist, wird die entsprechende Version
        // der Methode "toString" ausgeführt. Der Aufruf der Methode "sprechen",
        // die nur in "Papagei" definiert wurde, würde dementsprechend nicht
        // funktionieren.
