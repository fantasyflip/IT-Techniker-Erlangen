public class Test {
    ...
    // Parameters. Da bei generischen Datentypen die Vererbung allerdings
    // irrelevant ist, kann diese Methode niemals aufgerufen werden. Das liegt
    // daran, dass es keine Werkstatt vom Typ "Auto" geben kann, da "Auto"
    // abstrakt ist. Es kann also nur "BMW" oder "Mercedes" sein. Hätte die
    // Methode "Werkstatt<BMW> werkstatt" als Parameter könnte die Methode
    ...
    // Auch Methoden können generische Datentypen verwenden. Diese Methode kann
    // sowohl eine Werkstatt von BMW, als auch eine von Mercedes verarbeiten.
    ...
    // Alternativ kan auch mit einer Wildcard gearbeitet werden. Damit wird die
    // doppelte Prüfung des korrekten generischen Datentyps vermieden. Es wird
    // nur bei der Instanziierung der generischen Klasse geprüft.
    ...
    public static void main(String[] args) {
        ...
        // Erstellen einer Werkstatt. Es wird angenommen, dass nur Autos vom
        // gleichen Typen in einer Werkstatt behandelt werden
        ...
        // Da nur Autos des gleichen Typs in eine Werkstatt dürfen, wäre folgender
