public class Kassenpatient extends Patient {
     ...
     * eine PraxisVollException werfen kann. PraxisVollException MUSS behandelt werden:
     * Siehe Patient
     *
     ...
     * @throws PraxisVollException Wird vom Elternkonstruktor geworfen und hier
     *                              weitergegeben, wenn die Praxis voll ist.
     */
    public Kassenpatient(String name, String vorname, int alter, boolean familienversichert) throws PraxisVollException {
        ...
        // Dieser Aufruf kann eine PraxisVollException werfen, da der
        // Elternkonstruktor dies deklariert. Deshalb muss auch dieser
        // Konstruktor dieAusnahme deklarieren.
    ...
    // die bereits in "Patient" die Version aus der Klasse "Object" überschreibt,
    // überschrieben.
    ...
    public String toString(){
        ...
        // Mit dem Aufruf "super.toString()" wird innerhalb der neuen Version der Methode
        // "toString" die Version aus "Patient" ausgeführt. So müssen gleichbleibende
        // Inhalte nicht erneut geschrieben werden.
    ...
    // Überladung einer Methode: Die Methode "getName" existiert bereits in der
    // Elternklasse "Patient". Dort allerdings mit einem anderen Methodenkopf. In der
    // Elternklasse nimmt die Methode keine Parameter an.
    // Hier schon. Somit wird die Methode hier nicht überschrieben, sondern
    // überladen. Ein Objekt von "Kassenpatient" kann dadurch beide Varianten
    // aufrufen und verwenden. Siehe PatientTest.
